...
class Test_Emit_GeneralizedRipplePrefixSumRegistered extends AnyFreeSpec with ChiselScalatestTester {
  var verilog_dir="src/verilog/"

  "Emit_GeneralizedRipplePrefixSumRegistered_vectorLength2_inputBitWidth3" in {
      var filename="GeneralizedRipplePrefixSumRegistered_vectorLength2_inputBitWidth3.v"
      var intersect=chisel3.getVerilogString(new GeneralizedRipplePrefixSumRegistered(vectorLength = 2, inputBitWidth = 3))
