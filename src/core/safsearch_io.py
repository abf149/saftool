...
import core.safinfer_io as safinfer_io, \
       core.safmodel_io as safmodel_io
...
def parse_args():
    ...
    parser.add_argument('-C','--char',action='append',default=['!base'], \
    ...
    parser.add_argument('-g','--hcl',action='append',default=['!base'], \
    ...
    parser.add_argument('-r','--rtl',action='append',default=['!base'], \
    ...
    parser.add_argument('-u','--sim',action='append',default=['!base'], \
                        help='safmodel configuration file.')
