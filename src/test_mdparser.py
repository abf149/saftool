from saflib.microarchitecture.taxo.format.MetadataParser import MetadataParser, buildMetadataParser
...
mdparserBuilder=buildMetadataParser("C")
mdparser=mdparserBuilder.build("TestMDParser")
mdparserModel=MetadataParserModel.copy() \
                                 .from_taxo_obj(mdparser) \
...
energy_objectives, \
area_objectives, \
yields = mdparserModel.get_scale_inference_problem()

constraints.append('asdf.TestMDParser.md_in_rw == 2')
constraints.append('asdf.TestMDParser.md_in_cr >= 4')
constraints.append('asdf.TestMDParser.md_in_pr >= 2')
constraints.append('asdf.TestMDParser.md_in_ww >= 8')
#constraints.append('asdf.TestMDParser.md_in_pw >= 1')
constraints.append('asdf.TestMDParser.md_in_nc >= 8')
constraints.append('asdf.TestMDParser.at_bound_out_rw == 1')
constraints.append('asdf.TestMDParser.at_bound_out_pr >= 1/10')
constraints.append('asdf.TestMDParser.at_bound_out_cr >= 4')
constraints.append('asdf.TestMDParser.at_bound_out_ww >= 1')
#constraints.append('asdf.TestMDParser.pos_out_pw >= 1')
constraints.append('asdf.TestMDParser.at_bound_out_nc >= 8')
