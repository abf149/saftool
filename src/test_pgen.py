from saflib.microarchitecture.taxo.address_primitives.PositionGenerator import PositionGenerator, buildPositionGenerator
...
pgenBuilder=buildPositionGenerator("C")
pgen=pgenBuilder.build("TestPgen")
pgenModel=PositionGeneratorModel.copy() \
                                .from_taxo_obj(pgen) \
...
energy_objectives, \
area_objectives, \
yields = pgenModel.get_scale_inference_problem()

constraints.append('asdf.TestPgen.md_in_rw == 2')
constraints.append('asdf.TestPgen.md_in_cr >= 4')
constraints.append('asdf.TestPgen.md_in_pr >= 2')
constraints.append('asdf.TestPgen.md_in_ww >= 1')
constraints.append('asdf.TestPgen.md_in_pw >= 1')
constraints.append('asdf.TestPgen.md_in_nc >= 8')
constraints.append('asdf.TestPgen.pos_out_rw == 2')
constraints.append('asdf.TestPgen.pos_out_pr >= 2')
constraints.append('asdf.TestPgen.pos_out_cr >= 4')
constraints.append('asdf.TestPgen.pos_out_ww >= 1')
constraints.append('asdf.TestPgen.pos_out_pw >= 1')
constraints.append('asdf.TestPgen.pos_out_nc >= 8')
